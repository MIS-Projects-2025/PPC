    ...
    return (
        <>
            <span
                ...
                className={`flex items-center w-full h-full px-3 py-2 box-border transition-colors duration-100 ${
                    isHovering ? "bg-base-200" : "bg-transparent"
                }`}
            >
                {trigger}
            </span>
                ...
                <FloatingPortal>
                    ...
                    >
                        <FloatingArrow
                            ...
                            width={ARROW_SIZE * 2}
                            height={ARROW_SIZE}
                            className="fill-base-100 [&>path:first-child]:stroke-base-300"
                        />
